    ...
    <div class="row">
        <div class="col-sm-6 col-md-3 col-6">
            <div class="card mt-3" style="width: 100%;">
                <img class="card-img-top" src="{{asset('image/mu-chup-ss-in-hinh-canh-cut-mau-xam-tl-118177_1.jpg')}}"
                     alt="Card image cap">
                <div class="card-body">
            ...
            <div class="carousel-item active">
                <div class="row">
                    <div class="col-sm-4 col">
                        <img class="img-fluid"
                             src="{{asset('image/19985205_1007040769398785_7801387006000365568_n.jpg')}}" alt="">
                    </div>
                    <div class="col-sm-4 col">
                        <img class="img-fluid"
                             src="{{asset('image/19985205_1007040769398785_7801387006000365568_n.jpg')}}" alt="">
